...
func Test_LUKS1_Format(test *testing.T) {
	...
	err = device.Format(cryptsetup.LUKS1{Hash: "sha256"}, cryptsetup.GenericParams{Cipher: "aes", CipherMode: "xts-plain64", VolumeKeySize: 512 / 8})
	testWrapper.AssertNoError(err)
...
func Test_LUKS1_Load_ActivateByPassphrase_Deactivate(test *testing.T) {
	...
	device, err := cryptsetup.Init(DevicePath)
	testWrapper.AssertNoError(err)
	err = device.Format(luks1, cryptsetup.GenericParams{Cipher: "aes", CipherMode: "xts-plain64", VolumeKeySize: 512 / 8})
	testWrapper.AssertNoError(err)
...
func Test_LUKS1_ActivateByAutoGeneratedVolumeKey_Deactivate(test *testing.T) {
	...
	err = device.ActivateByVolumeKey(DeviceName, "", 512/8, cryptsetup.CRYPT_ACTIVATE_READONLY)
	testWrapper.AssertNoError(err)
